...
/*-----------------------------------------------
              @(target):= _test6_ext.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__test6_ext

#else
#  define SWIG_init    init_test6_ext

#endif
#define SWIG_name    "_test6_ext"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ; int arg2 ;
  double *arg3 = (double *) 0 ; int arg4 ; int arg5 ; double *arg6 = (double *) 0 ; int arg7 ; int arg8 ;
  double *arg9 = (double *) 0 ; PyArrayObject *array1 = NULL ; PyArrayObject *array4 = NULL ; PyArrayObject *array7 = NULL ;
  PyObject *swig_obj[3] ; if (!SWIG_Python_UnpackTuple(args, "add", 3, 3, swig_obj)) SWIG_fail; {
    array1 = obj_to_array_no_conversion(swig_obj[0], NPY_DOUBLE);
    if (!array1 || !require_dimensions(array1,2) || !require_contiguous(array1) || !require_native(array1)) SWIG_fail;
    ...
    if (!array4 || !require_dimensions(array4,2) || !require_contiguous(array4) || !require_native(array4)) SWIG_fail;
    arg4 = (int) array_size(array4,0); arg5 = (int) array_size(array4,1); arg6 = (double*) array_data(array4); }  {
    array7 = obj_to_array_no_conversion(swig_obj[2], NPY_DOUBLE);
    if (!array7 || !require_dimensions(array7,2) || !require_contiguous(array7) || !require_native(array7)) SWIG_fail;
    arg7 = (int) array_size(array7,0); arg8 = (int) array_size(array7,1); arg9 = (double*) array_data(array7); } 
  add(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9); resultobj = SWIG_Py_Void(); return resultobj; fail: return NULL; }
