...
/*-----------------------------------------------
              @(target):= _instant_module_b8fe2c0cfe8cfa730303f18528ee9d58fe6a2bcf.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__instant_module_b8fe2c0cfe8cfa730303f18528ee9d58fe6a2bcf

#else
#  define SWIG_init    init_instant_module_b8fe2c0cfe8cfa730303f18528ee9d58fe6a2bcf

#endif
#define SWIG_name    "_instant_module_b8fe2c0cfe8cfa730303f18528ee9d58fe6a2bcf"
...
SWIGINTERN PyObject *_wrap_sum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ; int arg2 ;
  double *arg3 = (double *) 0 ; int arg4 ; double *arg5 = (double *) 0 ; PyArrayObject *array1 = NULL ; int is_new_object1 = 0 ;
  PyObject *array4 = NULL ; PyObject *swig_obj[2] ; if (!SWIG_Python_UnpackTuple(args, "sum", 2, 2, swig_obj)) SWIG_fail; {
    npy_intp size[2] = { -1, -1 } ; array1 = obj_to_array_contiguous_force_conversion(swig_obj[0], NPY_DOUBLE, &is_new_object1);
    if (!array1 || !require_dimensions(array1, 2) || !require_size(array1, size, 2)) SWIG_fail;
    arg1 = (int) array_size(array1,0); arg2 = (int) array_size(array1,1); arg3 = (double*) array_data(array1); }  {
    npy_intp dims[1]; if (!PyInt_Check(swig_obj[1])) { const char* typestring = pytype_string(swig_obj[1]);
      PyErr_Format(PyExc_TypeError, "Int dimension expected.  '%s' given.", typestring); SWIG_fail; } 
    arg4 = (int) PyInt_AsLong(swig_obj[1]); dims[0] = (npy_intp) arg4; array4 = PyArray_SimpleNew(1, dims, NPY_DOUBLE);
    if (!array4) SWIG_fail; arg5 = (double*) array_data(array4); }  sum(arg1,arg2,arg3,arg4,arg5); resultobj = SWIG_Py_Void(); {
    resultobj = SWIG_Python_AppendOutput(resultobj,array4); }  { if (is_new_object1 && array1) { Py_DECREF(array1); }  } 
  return resultobj; fail: { if (is_new_object1 && array1) { Py_DECREF(array1); }  }  return NULL; }
