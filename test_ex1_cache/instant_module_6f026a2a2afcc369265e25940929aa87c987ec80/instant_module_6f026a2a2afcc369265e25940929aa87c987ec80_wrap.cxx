...
/*-----------------------------------------------
              @(target):= _instant_module_6f026a2a2afcc369265e25940929aa87c987ec80.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__instant_module_6f026a2a2afcc369265e25940929aa87c987ec80

#else
#  define SWIG_init    init_instant_module_6f026a2a2afcc369265e25940929aa87c987ec80

#endif
#define SWIG_name    "_instant_module_6f026a2a2afcc369265e25940929aa87c987ec80"
...
SWIGINTERN PyObject *_wrap_sum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ; int arg2 ;
  int arg3 ; double *arg4 = (double *) 0 ; int arg5 ; double *arg6 = (double *) 0 ; PyArrayObject *array1 = NULL ;
  PyArrayObject *array5 = NULL ; int is_new_object5 = 0 ; PyObject *swig_obj[2] ; double result;
  if (!SWIG_Python_UnpackTuple(args, "sum", 2, 2, swig_obj)) SWIG_fail; {
    array1 = obj_to_array_no_conversion(swig_obj[0], NPY_DOUBLE);
    if (!array1 || !require_dimensions(array1,3) || !require_contiguous(array1) || !require_native(array1)) SWIG_fail;
    arg1 = (int) array_size(array1,0); arg2 = (int) array_size(array1,1); arg3 = (int) array_size(array1,2);
    arg4 = (double*) array_data(array1); }  { npy_intp size[1] = { -1} ;
    array5 = obj_to_array_contiguous_force_conversion(swig_obj[1], NPY_DOUBLE, &is_new_object5);
    if (!array5 || !require_dimensions(array5, 1) || !require_size(array5, size, 1)) SWIG_fail;
    arg5 = (int) array_size(array5,0); arg6 = (double*) array_data(array5); } 
  result = (double)sum(arg1,arg2,arg3,arg4,arg5,arg6); resultobj = SWIG_From_double(static_cast< double >(result)); {
    if (is_new_object5 && array5) { Py_DECREF(array5); }  }  return resultobj; fail: { if (is_new_object5 && array5) {
      Py_DECREF(array5); }  }  return NULL; }
