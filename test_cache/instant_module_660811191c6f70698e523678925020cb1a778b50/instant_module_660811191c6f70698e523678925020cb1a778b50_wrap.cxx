...
/*-----------------------------------------------
              @(target):= _instant_module_660811191c6f70698e523678925020cb1a778b50.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__instant_module_660811191c6f70698e523678925020cb1a778b50

#else
#  define SWIG_init    init_instant_module_660811191c6f70698e523678925020cb1a778b50

#endif
#define SWIG_name    "_instant_module_660811191c6f70698e523678925020cb1a778b50"
...
SWIGINTERN PyObject *_wrap_sum(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ;
  double *arg2 = (double *) 0 ; PyArrayObject *array1 = NULL ; int i1 = 0 ; PyObject *swig_obj[1] ; double result;
  if (!args) SWIG_fail; swig_obj[0] = args; { array1 = obj_to_array_no_conversion(swig_obj[0], NPY_DOUBLE);
  ...
  result = (double)sum(arg1,arg2); resultobj = SWIG_From_double(static_cast< double >(result)); return resultobj; fail:
  return NULL; }
SWIGINTERN PyObject *_wrap_max(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ;
  double *arg2 = (double *) 0 ; PyArrayObject *array1 = NULL ; int i1 = 0 ; PyObject *swig_obj[1] ; double result;
  if (!args) SWIG_fail; swig_obj[0] = args; { array1 = obj_to_array_no_conversion(swig_obj[0], NPY_DOUBLE);
    if (!array1 || !require_dimensions(array1,1) || !require_contiguous(array1) || !require_native(array1)) SWIG_fail; arg1 = 1;
    for (i1=0; i1 < array_numdims(array1); ++i1) arg1 *= array_size(array1,i1); arg2 = (double*) array_data(array1); } 
  result = (double)max(arg1,arg2); resultobj = SWIG_From_double(static_cast< double >(result)); return resultobj; fail:
  return NULL; }
