...
/*-----------------------------------------------
              @(target):= _instant_module_13e1c5a7533e08f1b8225a1bce5cc844ec4cc4ec.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__instant_module_13e1c5a7533e08f1b8225a1bce5cc844ec4cc4ec

#else
#  define SWIG_init    init_instant_module_13e1c5a7533e08f1b8225a1bce5cc844ec4cc4ec

#endif
#define SWIG_name    "_instant_module_13e1c5a7533e08f1b8225a1bce5cc844ec4cc4ec"
