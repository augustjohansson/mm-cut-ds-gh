...
/*-----------------------------------------------
              @(target):= _test5_ext.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__test5_ext

#else
#  define SWIG_init    init_test5_ext

#endif
#define SWIG_name    "_test5_ext"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_add(PyObject *SWIGUNUSEDPARM(self), PyObject *args) { PyObject *resultobj = 0; int arg1 ;
  double *arg2 = (double *) 0 ; int arg3 ; double *arg4 = (double *) 0 ; int arg5 ; double *arg6 = (double *) 0 ;
  PyArrayObject *array1 = NULL ; int i1 = 0 ; PyArrayObject *array3 = NULL ; int i3 = 0 ; PyArrayObject *array5 = NULL ;
  int i5 = 0 ; PyObject *swig_obj[3] ; if (!SWIG_Python_UnpackTuple(args, "add", 3, 3, swig_obj)) SWIG_fail; {
    ...
    if (!array5 || !require_dimensions(array5,1) || !require_contiguous(array5) || !require_native(array5)) SWIG_fail; arg5 = 1;
    for (i5=0; i5 < array_numdims(array5); ++i5) arg5 *= array_size(array5,i5); arg6 = (double*) array_data(array5); } 
  add(arg1,arg2,arg3,arg4,arg5,arg6); resultobj = SWIG_Py_Void(); return resultobj; fail: return NULL; }
